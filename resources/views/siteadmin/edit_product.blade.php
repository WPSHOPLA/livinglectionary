        ...
        <div class="col-md-12">
            <div class="box dark">
                    ...
                    <div class="form-group">
                        ...
                        <!--select class="form-control" name="category" id="Product_Category" required
                            ...
                            <select class="form-control" name="category" id="Product_Category" required>
                                ...
                                <option value="<?php echo $cat_list->mc_id; ?>"
                                        <?php if($cat_list->mc_id == $category_get) { ?> selected <?php } ?> ><?php echo $cat_list->mc_name; ?></option>
                                <?php } ?>
                            </select>
                ...
                <!--div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="Select_Merchant" class="control-label col-md-2">Select Merchant<span
                                    class="text-sub">*</span></label>

                        <div class="col-md-8">
                            <select class="form-control" name="Select_Merchant" id="Select_Merchant"
                                    onchange="select_shop_from_merchant(this.value, '<?php echo url('product_getmerchantshop_ajax'); ?>', 'Select_Shop', '{{$shop}}');">
                                @foreach ($merchantdetails as $merchantval)
                                    <option value="<?php echo $merchantval->mem_id;?>"
                                            <?php if($merchantval->mem_id == $merchant) { ?>  selected <?php } ?> >{!!$merchantval->mem_fname.' '.$merchantval->mem_lname!!}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8" id="img_upload">
                            ...
                            <input type="hidden" id="aid" name="aid" value="<?php echo $img_count; ?>">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var max_file_size = parseFloat(max_file_size);
        ...
        function addimgFormField() {
            ...
            if (count_id < 4) {
                ...
                jQuery.noConflict();
                jQuery("#divTxt").append("<div class='imgrow' id='row" + id + "'><dd><input type='file' onChange='readURL(this)' data-fid=" + count_id + " id='file_more" + count_id + "'  name='file_more" + count_id + "' /></dd><dd>&nbsp;&nbsp<a href='#' onClick='removeFormField(\"#row" + id + "\"); return false;' style='color:#F60;' ><i class='icon icon-trash'></i></a></dd> \ " +
                        "<input type='hidden' id= 'x" + count_id + "' name='x" + count_id + "'><input type='hidden' id= 'y" + count_id + "'  name='y" + count_id + "'><input type='hidden' id= 'w" + count_id + "'  name='w" + count_id + "'><input type='hidden' id= 'h" + count_id + "'  name='h" + count_id + "'></div>");
